...
Vue.component("obj-head", {
  template: `<a-entity>
    <a-obj-model src="#cowboyhat" position="0 0.2 0" mtl="#stage-mtl" scale="1 1 1">
		</a-obj-model>
...
Vue.component("obj-world", {
  template: `
    ...
    <a-light type="directional" 
		...
		<a-obj-model src="#stage-obj" position="-10 0 0" mtl="#stage-mtl" scale="0.08 0.08 0.08" rotation="0 270 0">
		</a-obj-model>
    
    
    <a-obj-model src="#dillo-obj" mtl="#dillo-mtl" @click="clickDillo" scale="0.04 0.04 0.04" position="5 0 0" rotation="270 0 90">
		</a-obj-model>

    <a-obj-model src="#tent" position="30 0 0" scale="0.03 0.03 0.03">
		</a-obj-model>
    <a-obj-model src="#tent" position="30 0 10" scale="0.03 0.03 0.03">
		</a-obj-model>
    
		<a-sound :sound="'src:'+ this.song" autoplay="true" loop="true" volume="0.5"></a-sound>
		<!-- <a-box 
  ...
  mounted() {
    ...
    this.room.detailText = "Click on the Dillo to get a fortune!";
